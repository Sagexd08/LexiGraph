 ...
 * Comprehensive design tokens for the LexiGraph application
 */
...
export const variants = {
  button: {
    ...
    glass: 'bg-glass-white backdrop-blur-md border border-white/20',
  },
  
  card: {
    default: 'bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800',
    glass: 'bg-glass-white backdrop-blur-xl border border-white/20',
    elevated: 'bg-white dark:bg-neutral-900 shadow-xl border border-neutral-200 dark:border-neutral-800',
